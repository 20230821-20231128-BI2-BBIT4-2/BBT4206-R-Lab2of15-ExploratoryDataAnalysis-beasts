...
Describe the code chunk here: command to load the dataset
...
Describe the next code chunk here: command to display datatypes
...
Describe the next code chunk here: command to display dimensions
